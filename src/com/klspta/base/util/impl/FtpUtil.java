...
public class FtpUtil extends AbstractBaseBean implements IFtpUtil {
	...
	public FTPClient getFtpClient() {
		...
		try {
			ftpClient.connect((String)ftpConfigMap.get("FTP_HOST"), Integer.parseInt((String)ftpConfigMap.get("FTP_PORT")));
			ftpClient.login((String)ftpConfigMap.get("FTP_USERNAME"), (String)ftpConfigMap.get("FTP_PASSWORD")); 
		} catch (Exception e) {
			e.printStackTrace();
		}
		return ftpClient;
