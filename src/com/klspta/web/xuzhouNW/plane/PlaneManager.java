package com.klspta.web.xuzhouNW.plane;
...
/**
 * <br>Title: 无人机低空遥感监测图斑管理类
 * <br>Description:
 * <br>Author:郭润沛
 * <br>Date:2013-5-24
 */
public class PlaneManager extends AbstractBaseBean {

    /**
     * 
     * <br>Description:获取所有遥感监测图斑
     * <br>Author:郭润沛
     * <br>Date:2012-8-10
     */
    public void getAllList() {
        ...
        if (hzqhs2 == "") {
            ...
            if (hzqhs3 == "" && hzqhs2 != "") {
                ...
                addsql = "  (t.xzqhdm='" + hzqhs1 + "' or t.xzqhdm='" + hzqhs2 + "' or t.xzqhdm='" + hzqhs3
                        + "')";
            }
        }
        ...
        if (keyWord != null && !"".equals(keyWord)) {
            ...
            where += " and (" + strColumnName + " like '%"
                    + (keyWord.replaceAll(" ", "%' and " + strColumnName + "  like '%")) + "%')";//查询条件
        }
        String sql = "select t.TBBH, t.XZQHMC,to_char(t.TBMJ) tbmj, t.QSX, t.HSX,to_char(t.TIME,'yyyy-MM-dd') WPLD from PLANE_TB t where  "
                + addsql;
        sql += where;
    ...
    public void getyswfList() {
        ...
        if (hzqhs2 == "") {
            ...
            if (hzqhs3 == "" && hzqhs2 != "") {
                ...
                addsql = " (t1.xzqhdm='" + hzqhs1 + "' or t1.xzqhdm='" + hzqhs2 + "' or t1.xzqhdm='" + hzqhs3
                        + "')";
            }
        }
    ...
    public void getspyswfList() {
        ...
        String sql = null;
        String sqlsp = "select * from wpzf_analyse_sp t2,PLANE_TB t1 where t1.tbbh=t2.tbbh and " + addsql;
        ...
        sql = "select t1.tbbh,t1.xzqhmc,to_char(t1.tbmj) tbmj,to_char(t1.TIME,'yyyy-MM-dd') year,to_char(t2.ygmj) ygmj,t2.ygbl,t2.xmmc,t2.pzwh,"
                + "decode(t1.ajstatus,'1','未下发','已下发') xiafa from PLANE_TB t1,wpzf_analyse_sp t2 "
                + "where t1.tbbh = t2.tbbh  and decode(t2.ygbl,null,'0.0',t2.ygbl) < 0.7 and " + addsql;
    ...
    public void getgdyswfList() {
        ...
        sql = "select t1.tbbh,t1.xzqhmc,to_char(t1.tbmj) tbmj,to_char(t1.TIME,'yyyy-MM-dd') year,t2.xmmc,t2. gdwh,to_char(t2.ygmj) ygmj,t2.ygbl, "
                + "decode(t1.ajstatus,'1','未下发','已下发') xiafa from PLANE_TB t1,wpzf_analyse_gd t2 where  t1.tbbh=t2.tbbh "
    ...
    public void gethfList() {
        ...
        if (hzqhs2 == "") {
            ...
            if (hzqhs3 == "" && hzqhs2 != "") {
                ...
                addsql = " ( t1.xzqhdm='" + hzqhs1 + "' or t1.xzqhdm='" + hzqhs2 + "' or t1.xzqhdm='"
                        + hzqhs3 + "')";
            }
        }
        ...
        String sql = null;
        sql = "select t1.tbbh, t1.xzqhmc, to_char(t1.tbmj) tbmj,t2.xmmc spxmmc,t3.xmmc gdxmmc,t1.qsx, t1.hsx, to_char(t1.TIME,'yyyy-MM-dd') wpld from PLANE_TB t1, wpzf_analyse_sp t2, wpzf_analyse_gd t3 where t1.tbbh = t2.tbbh   and t1.tbbh = t3.tbbh and t2.ygbl > 0.7  and  t3.ygbl > 0.7 and"
                + addsql;
        sql += where;
        sql += " order by t1.time desc";
        List<Map<String, Object>> resultList = query(sql, YW);
    ...
    public void getwpwgList() {
        ...
        String sql = "select t.TBBH, t.XZQHMC, to_char(t.TBMJ) tbmj, t.QSX, t.HSX, to_char(t.TIME,'yyyy-MM-dd') WPLD,decode(t.ajstatus,'1','未下发','已下发') xiafa from PLANE_TB t where"
    ...
    public void getwpxzList() {
        ...
        String sql = "select t.TBBH, t.XZQHMC, to_char(t.TBMJ) tbmj, t.QSX, t.HSX,to_char(t.TIME,'yyyy-MM-dd') WPLD,decode(t.ajstatus,'1','未下发','已下发') xiafa  from PLANE_TB t where ( t.ajstatus='1' or t.ajstatus='2')and "
                + addsql;
        sql += where;
        sql += "  order by t.time desc";
        List<Map<String, Object>> resultList = query(sql, YW);
    ...
    public void getjbsxList() {
        ...
        String sql = "select TBBH,XZQHMC,XZQHDM,TBMJ,X,Y,QSX,HSX,YEAR from PLANE_TB t where  t.TBBH='"
                + yw_guid + "'";
    ...
    public void getspList() {
        String yw_guid = request.getParameter("yw_guid");
        List allRows = new ArrayList();
        String sql = "select PZWH,XMMC,YGMJ,YGBL,PZSJ from WPZF_ANALYSE_SP t where  t.TBBH='" + yw_guid + "'";
        List listYw = query(sql, YW);
        int i = 0;
        if (listYw.size() > 0) {
            Map map = (Map) listYw.get(0);
    ...
    public void getgdList() {
        String yw_guid = request.getParameter("yw_guid");
        List allRows = new ArrayList();
        String sql = "select GDWH,XMMC,YGMJ,YGBL,GDSJ from WPZF_ANALYSE_GD t where  t.TBBH='" + yw_guid + "'";
        List listYw = query(sql, YW);
        int i = 0;
        List oneRow1 = new ArrayList();
        if (listYw.size() > 0) {
    ...
    public void getxzList() {
        String yw_guid = request.getParameter("yw_guid");
        List allRows = new ArrayList();
        String sql = "select b.XZQHMC,b.TBMJ,a.NYDMJ,a.GDMJ,a.JSYDMJ,a.WLYDMJ from WPZF_ANALYSE_XZ a,PLANE_TB b where  a.TBBH='"
    ...
    /**
          * 
          * <br>Description:获取卫片图斑详细地类数据
          * <br>Author:郭润沛
          * <br>Date:2012-7-26
    */
    public void getxxdlList() {
        String yw_guid = request.getParameter("yw_guid");
        String sql = "select TBBH,DLMC,QSDWMC,YGMJ from WPZF_ANALYSE_XZ_DLTB t where t. TBBH='" + yw_guid
                + "'";
    ...
    */
    ...
    /**
        * 
        * <br>Description:获取卫片图斑历史核查情况分析数据
        * <br>Author:郭润沛
        * <br>Date:2012-7-26
    */
    @SuppressWarnings("unchecked")
