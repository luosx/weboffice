...
public class XchcManager extends AbstractBaseBean {
    ...
    public static final String[][] showXCList = new String[][]{{"GUID", "0.15","任务编号"},{"YDXMMC", "0.1","用地项目名称"},{"YDZT", "0.08","用地主体"},{"YDWZ", "0.12","用地位置"},{"ZDMJ","0.08","占地面积(亩)"},{"GDMJ","0.08","耕地面积(亩)"},{"JZMJ","0.08","建筑面积(亩)"},{"JZXZ","0.1","建筑现状"},{"YT","0.1","用途"},{"XIANGXI","0.05","详细信息"},{"DELETE","0.05","删除"}};
    public static final String[][] showHCList = new String[][]{{"GUID", "0.15","任务编号"},{"XZQMC", "0.1","所在政区"},{"YDDW", "0.11","用地单位"},{"YDSJ", "0.09","用地时间"},{"TDYT","0.08","土地用途"},{"JSQK","0.08","建设情况"},{"YDQK","0.08","用地情况"},{"DFCCQK","0.1","地方查处情况"},{"WFWGLX","0.1","违法违规类型"},{"XIANGXI","0.05","详细信息"},{"DELETE","0.05","删除"}};
