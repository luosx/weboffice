...
public class ZjglBuild {
	...
	public static StringBuffer buildTitle(String year) {
		...
		Buffer.append("<table  width='1900px' id='table'>"
			...
			+ "<td rowspan='3'  align='center' width='150px' class='title'>累计已缴纳<br>/已审批资金</td>"
	...
	public static StringBuffer buildSum(){
		...
		+ "<td align='center' width='130px' class='tr01'>0</td>"
		+ "<td align='center' width='83px' class='tr01'>0</td>"
		+ "<td align='center' width='83px' class='tr01'>0</td>"
		+ "<td align='center' width='83px' class='tr01'>0</td>"
		+ "<td align='center' width='83px' class='tr01'>0</td>"
		+ "<td align='center' width='83px' class='tr01'>0</td>"
		...
		if (list != null) {
			for (int i = 0; i < list.size(); i++) {
				if (i == 0) {
					...
					+ "@ysfy'/>"+ delNull(String.valueOf(list.get(i).get("YSFY")))+"</td><td  class='"+sytle+"' id='" + String.valueOf(list.get(i).get("tree_id"))
					+ "@" + String.valueOf(list.get(i).get("tree_name"))
					+ "@"+String.valueOf(list.get(i).get("parent_id"))
					+ "@jl2'>"+ delNull(String.valueOf(list.get(i).get("JL2")))+"</td><td class='"+sytle+"' id='" + String.valueOf(list.get(i).get("tree_id"))
					+ "@" + String.valueOf(list.get(i).get("tree_name"))
					+ "@"+String.valueOf(list.get(i).get("parent_id"))
					+ "@yfsdz'>"+ delNull(String.valueOf(list.get(i).get("YFSDZ")))+"</td><td class='"+sytle+"' id='" + String.valueOf(list.get(i).get("tree_id"))
					+ "@" + String.valueOf(list.get(i).get("tree_name"))
					+ "@"+String.valueOf(list.get(i).get("parent_id"))
		...
		if (list != null) {
			for (int i = 0; i < list.size(); i++) {
				if (i == 0) {
					...
					+ "' id='" + String.valueOf(list.get(i).get("tree_id"))
					+ "@" + String.valueOf(list.get(i).get("tree_name"))
					+ "@"+String.valueOf(list.get(i).get("parent_id"))+"@ysfy'/>"+ delNull(String.valueOf(list.get(i).get("YSFY")))+"</td><td  class='"+sytle+"' id='" + String.valueOf(list.get(i).get("tree_id"))
					+ "@" + String.valueOf(list.get(i).get("tree_name"))
					...
					+ "' id='" + String.valueOf(list.get(i).get("tree_id"))
							+ "@" + String.valueOf(list.get(i).get("tree_name"))
							+"@"+String.valueOf(list.get(i).get("parent_id"))+ "@"+ items[j] +"'/>"+ delNull(String.valueOf(list.get(i).get(items[j]))));
					}
					stringBuffer.append("</td><td class='"+sytle+"' id='" + String.valueOf(list.get(i).get("tree_id"))
							+ "@" + String.valueOf(list.get(i).get("tree_name"))
				...
				for (int i = 0; i < list.size(); i++) {
					if (i == 0) {
						stringBuffer.append("<tr><td  class='"+sytle+"'>"
										...
										+ "@cqye'>" + delNull(String.valueOf(list.get(i).get("CQYE"))) + "</td>");
						for (int j = 0; j < items.length; j++) {
							stringBuffer.append("<td class='"+sytle+"'"
										+ "' id='" + String.valueOf(list.get(i).get("tree_id"))
										+ "@" + String.valueOf(list.get(i).get("tree_name"))
										+ "@"+String.valueOf(list.get(i).get("parent_id"))
										+ "@"+ items[j] +"'/>"+ delNull(String.valueOf(list.get(i).get("YSFY")))+"</td>");
						}
						stringBuffer.append("<td class='"+sytle+"'  id='" + String.valueOf(list.get(i).get("tree_id"))
										+ "@" + String.valueOf(list.get(i).get("tree_name"))
										+ "@"+String.valueOf(list.get(i).get("parent_id"))
