...
//		}
	 ...
	 * @return
	 */
	public String getWWMenuCode(User user, String parentId, int maxLevel)
	{
		List<MenuBean> list = getMenuList(user);
		Map<String, List<MenuBean>> menuMap = getMenuMap(list);
	 ...
	 * @return
	 */
	private String buildWWMenuCode(List<MenuBean> list, Map<String, List<MenuBean>> menuMap, String parentId, int menuLevel, int maxLevel)
	{
		listSort(list);
		StringBuffer menuCode = new StringBuffer();
		if (maxLevel != 0 && maxLevel < menuLevel){
	 ...
	 * @return
	 */
	private StringBuffer getWWMenuItemCode(MenuBean menuBean, boolean isLeaf, int menuLevel)
	{
		StringBuffer menuItemCode = new StringBuffer();
		String mouseOver = "red";
		String mouseOut = "black";
