...
import com.klspta.console.flex.FlexManager;
...
public class ManagerFactory {
    ...
    public static FlexManager getFlexManage() throws Exception {
        return FlexManager.getInstance("NEW WITH MANAGER FACTORY!");
    }
