...
public class UserManager extends AbstractBaseBean{
    ...
    public static UserManager getInstance(String key) throws Exception{
    ...
    public User getUserWithUserNameAndPassword(String userName,String passWord) throws Exception
    {
     ...
     * @throws Exception
     */
    public boolean addUserRoleMap(String roleId,List<String> userNames) throws Exception
    {
    	//删除
    	String sql="delete from map_user_role where role_id=?";
    	update(sql, CORE,new Object[]{roleId});
    	//添加
    	StringBuffer sqlBuf=new StringBuffer("insert into map_user_role(role_id,user_id)(select ?,t.id from core_users t where t.id in (");
    ...
    /**
     * 
     * <br>Description:根据角色id获取用户列表的json
     * <br>Author:任宝龙
     * <br>Date:2012-6-14
     * @param roleId
     * @return
    ...
    /**
     * 
     * <br>Description:获取非roleId的用户列表的json
     * <br>Author:任宝龙
     * <br>Date:2012-6-14
     * @param roleId
     * @return
    ...
    public List<Object> getAllUser(String roleId) {
        String sql1 = "select user_id from map_user_role where role_id='" + roleId + "'";
        List<Map<String,Object>> userIdList = query(sql1,CORE);
        List<Object> list = new ArrayList<Object>();
        for (int i = 0; i < userIdList.size(); i++) {
            Map<String,Object> userMap = (Map<String,Object>) userIdList.get(i);
