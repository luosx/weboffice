...
html, body { 
		...
		Ext.onReady(function(){
		   	putClientCommond("wjspHandler","getSYHJZYJYCLList");
			myData = restRequest();
...
function viewDetail(id){	
	var url = "<%=basePath%>web/sanya/zhbg/zhbgdj/wjspTab.jsp?type=syhjzyj&yw_guid=" + myData[id-1].YW_GUID;
	document.location.href = url;	
}

//点击查看时，查看详细信息
function process(id){
	var url = "<%=basePath%>web/sanya/zhbg/zhbgdj/wjspTab.jsp?type=syhjzyj&yw_guid=" + id;
	document.location.href = url;
	//window.open(url);
}
...
function query(){
	var keyWord=Ext.getCmp('keyword').getValue();
   	putClientCommond("wjspHandler","getSYHJZYJYCLListByKeyWords");
