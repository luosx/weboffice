...
<html>
 ...
 Ext.onReady(function(){
   var result = ajaxRequest("<%=basePath%>","xuzhouWWManager","getAllCarData","");
    alert(result);
    ...
    document.getElementById('accord').checked="";
	document.getElementById('condition').value="";
       ...
       labelWidth:120,	
       width:380, 
       url:"<%=basePath%>formOperationAC.do?method=saveForm&formBeanType=",
