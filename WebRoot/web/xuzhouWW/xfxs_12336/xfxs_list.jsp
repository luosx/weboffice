...
function viewDetail(){
    ...
    window.location.href="<%=basePath%>web/xuzhouWW/xfxs_12336/xzzfTab.jsp?jdbcname=YWTemplate&style=1&yw_guid="+yw_guid;
}
function xzxs(){
    var yw_guid = ajaxRequest("<%=basePath%>","Xfxs_12336Manager","getXzxsYW_GUID","");
    window.location.href("<%=basePath%>web/xuzhouWW/xfxs_12336/xzzfTab.jsp?jdbcname=YWTemplate&style=0&yw_guid="+yw_guid); 
}
</script>
	</head>
