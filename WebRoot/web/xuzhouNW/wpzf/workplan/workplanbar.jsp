  ...
  Ext.onReady(function (){
  	...
  	var toolbar = new Ext.Toolbar({ 
  	 renderTo: "div_view",   
        frame: true,   
        items:[   
            {id:"workplan", text:"工作计划", iconCls:"report",icon:'<%=basePath%>web/xuzhouNW/wpzf/image/edit.png',handler: onMenuItem},"-",
            {id:"worknotice", text:"工作通知", iconCls:"report",icon:'<%=basePath%>web/xuzhouNW/wpzf/image/faq.png',handler: onMenuItem},"-",
            {id:"refresh", text:"刷新", iconCls:"refresh",icon:'<%=basePath%>web/xuzhouNW/wpzf/image/0001.png',handler: onMenuItem}   
        ]   
    });
  });
...
if(item.text=='工作计划'){
 document.getElementById('bot').src="<%=basePath%>web/xuzhouNW/wpzf/workplan/1/anygantt.html";
    ...
    document.getElementById('bot').src="<%=basePath%>web/xuzhouNW/wpzf/workplan/worknotice.jsp";
