...
<%
    ...
    String url = "";
    url=basePath+"web/xuzhouNW/wpzf/tjfx/hefei.html";
...
<html>
	...
	<frameset id="qbtb" name="qbtb" rows="10%,*" frameborder="no" border="0" framespacing="0" >
		<frame id="toolbar" name="toolbar"  noresize src="<%=basePath%>web/xuzhouNW/wpzf/tjfx/wpzf_topBar.jsp?xzqhdm=<%=xzqhdm%>" />
