...
Ext.onReady(function(){
	putClientCommond("planeManager","getwpxzList");
    ...
    var height=document.body.clientHeight * 0.95 ;
        ...
        columns: [
            ...
            {header: '前时相', dataIndex:'QSX', width: width*0.14, sortable: true,renderer:changKeyword},
            {header: '后时相', dataIndex:'HSX', width: width*0.14, sortable: true,renderer:changKeyword},
            {header: '卫片时间', dataIndex:'WPLD', width: 0, sortable: true,renderer:changKeyword},
...
function query(){
	...
	grid.reconfigure(store, new Ext.grid.ColumnModel([
            ...
            {header: '政区名称', dataIndex:'XZQHMC', width: width*0.16, sortable: true,renderer:changKeyword},
            {header: '监测面积', dataIndex:'TBMJ', width: width*0.08, sortable: true,renderer:changKeyword},
            {header: '前时相特征', dataIndex:'QSX', width: width*0.14, sortable: true,renderer:changKeyword},
            {header: '后时相特征', dataIndex:'HSX', width: width*0.14, sortable: true,renderer:changKeyword},
