...
if(item == '报表')
{
	parent.view.location.href="<%=basePath%>web/xuzhouNW/plane/tjfx/hefei.html";
}
if(item == "柱状图"){
parent.view.location.href="<%=basePath%>web/xuzhouNW/plane/tjfx/chartfile/chart.jsp?xml=tj_z.xml";
}
if(item == "饼状图"){
