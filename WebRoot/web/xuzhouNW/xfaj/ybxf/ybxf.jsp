...
Ext.onReady(function(){
   putClientCommond("xfaj","getFinishList");
...
function process(id){
	...
	var url='<%=basePath%>model/workflow/wf.jsp?yw_guid='+yw_guid+'&wfInsTaskId='+wfInsTaskId+'&activityName='+escape(escape(activityName))+'&zfjcType=8&wfInsId='+wfInsId+'&zfjcName='+escape(escape('信访案件查处'))+'&wfId='+zfjcType+'&returnPath='+returnPath+'&buttonHidden=<%=buttonHidden%>&edit=false';  
	//window.open(url); 
