    ...
    grid = new Ext.grid.GridPanel({
        ...
        columns: [
           ...
           // new Ext.grid.RowNumberer(),
        	{header: '线索号', dataIndex:'XSH',width: width*0.16, sortable: false},
            ...
            {header: '问题发生地', dataIndex:'WTFSD7', width: width*0.2, sortable: false},
            ...
            {header: '信息', dataIndex:'ROWNUM1', width: width*0.1, sortable: false, renderer:view}
...
function issuedTask(){
 	window.showModalDialog("<%=basePath%>web/xuzhouNW/ajgl/xfjb/xiafa.jsp","","dialogWidth=650px;dialogHeight=450px;status=no;scroll=no");
}
