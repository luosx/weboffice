...
<div align="center"><h1>建设用地划拨表</h1></div>
<form method="post">
<table id="xcrztable" class="lefttopborder1" cellspacing="0" cellpadding="0" border="1"  bgcolor="#FFFFFF" bordercolor="#000000" width="600">
  ...
  <tr>
   		<td>划拨时间</td>
   		<td>
   			<input type="text" class="underline" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" name="hbsj" id="hbsj" style="width: 97%"/>
   		</td>
   		<td>划拨决定书编号</td>
   		<td>
   			<input type="text" class="noborder" name="hbjdsbh" id="hbjdsbh" style="width: 97%"/>
   		</td>
   </tr>
   <tr>
   		<td >备注</td>
