...
Ext.onReady(function(){
	putClientCommond("lacc","getXCdata");
	myData = restRequest();
    ...
    grid = new Ext.grid.GridPanel({
        ...
        columns: [
            ...
            {header: '现场情况描述', dataIndex:'XCQKMC',width: width*0.06, sortable: true}, 
            ...
            {header: '是否违法',dataIndex:'SFWF', width: width*0.04, sortable: true,renderer:changKeyword}, 
...
var guid=myData[id].GUID;
window.location.href="<%=basePath%>web/default/commandcenter/ExternalNetwork/PADDataList/PADXcInfoTab.jsp?yw_guid="+myData[id].GUID;
}
//合法按钮
function checkLegal(){
  var ids="";
