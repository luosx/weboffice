...
input,img {
	vertical-align: middle;
	   ...
	   var tabs = new Ext.TabPanel({
        ...
        items:[{
                title: '审批叠加',
               html: "<iframe width='"+w+"' height='"+h+"' src='<%=basePath%>/web/qingdaoNW/wpzf/analysis/spList.jsp?yw_guid=<%=yw_guid%>' />" 
           },{
                title: '供地叠加',
               html: "<iframe width='"+w+"' height='"+h+"' src='<%=basePath%>/web/qingdaoNW/wpzf/analysis/gdList.jsp?yw_guid=<%=yw_guid%>' />" 
           }
        ]
    })
