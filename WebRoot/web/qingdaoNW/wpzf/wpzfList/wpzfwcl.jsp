...
html, body { 
		...
		Ext.onReady(function(){
		   	putClientCommond("wpzfHandler","getWCLList");
        	...
        	grid = new Ext.grid.GridPanel({
        		...
        		columns: [
		            ...
		            {header: '图斑位置', dataIndex:'XMC', width: width * 0.20, sortable: true,renderer:changKeyword},
		            {header: '图斑类型', dataIndex:'TBLX', width: width * 0.15, sortable: true,renderer:changKeyword},
		            {header: '图斑年度', dataIndex:'YEAR', width: width * 0.20, sortable: true,renderer:changKeyword},
		            {header: '图斑面积', dataIndex:'AREA', width: width * 0.20, sortable: true,renderer:changKeyword},
...
//点击查看时，查看详细信息
function process(id){
	var url = "<%=basePath%>/web/qingdaoNW/wpzf/wpzfNR/wpTab.jsp?year=<%=year%>&yw_guid=" + id;
