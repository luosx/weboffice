           ...
           listeners: {
         	'click': function(node, e){
               ...
               if(parentid=='14'){
            	  setTimeout(function()
            			  {
            				  window.open("<%=basePath%>web/qingdaoNW/tjfx/chart.jsp?xml="+id,'chart','height=600,width=900,left='+left+',top='+top+',toolbar=no,menubar=no,scrollbars=no,resizable=no,location=no,status=no');
            			  }
            			  ,10);
