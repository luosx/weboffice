...
<%@page import="com.klspta.web.qingdaoNW.dtxc.DtxcManager"%>
<%
...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>web/qingdaoNW/dtxc/xcrz/js/xcrz.js"></script>
  ...
  <script type="text/javascript">
	...
	function impxccg(){
		...
		var simInfo =  window.showModalDialog("<%=basePath%>web/qingdaoNW/dtxc/wyxc/dtxccg.jsp",null,feature); 
  ...
  <script type="text/javascript">
 	function viewCG(){
		...
		window.showModalDialog("<%=basePath%>web/qingdaoNW/dtxc/wyxc/xjclyjframe.jsp?zfjcType=13&yw_guid="+yw_guid,obj,"dialogWidth="+width+";dialogHeight="+height);
	}
  	<%
