...
Ext.onReady(function(){
    ...
    grid = new Ext.grid.GridPanel({
        ...
        columns: [
           ...
           {header: '办理人员',dataIndex:'ASSIGNEE_',width: width*0.07, sortable: true},
...
function pro(id){
//id = id -1;
 return "<a href='#'onclick='process("+id+");return false;'><img src='<%=basePath%>web/qingdaoNW/lacc/dbaj/images/view.png' alt='详细'></a>";
}
...
function process(id){
	...
	var zfjcType="90";
	var returnPath="web/qingdaoNW/lacc/ajcx/ajdcblz.jsp";
