...
function pro(id){
 //id = id -1;
 return "<a href='#'onclick='process("+id+");return false;'><img src='<%=basePath%>web/v/lacc/dbaj/images/view.png' alt='详细'></a>";
}

function process(id){
	var wfInsId=myData[id].WFINSID;
	var yw_guid=myData[id].YW_GUID;
	var returnPath="web/qingdaoNW/lacc/ybaj/ybaj.jsp";
