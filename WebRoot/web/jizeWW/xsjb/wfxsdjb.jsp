...
<html>
	...
	style="position: absolute; top: 5px; left: 10px">
			<img src="web/jizeWW/xsjb/images/save.png" alt="保存" onclick="save(this,'1')" /><br/>
			<img src="web/jizeWW/xsjb/images/issued.png" alt="下发" onclick="showReport()"  width=24 height=24/>
			</div>
	...
	{	
		...
		{	
			  ...
			  var result=window.showModalDialog("<%=basePath%>web/jizeWW/xfxs_12336/xfrw.jsp",dqName,"dialogWidth=300px;dialogHeight=200px;status=no;scroll=no"); 
				if(result=="true")
					alert("下发任务成功！");
		}
		else
