...
function viewDetail(){
    ...
    window.location.href="<%=basePath%>web/jizeWW/xsjb/xfxsTab.jsp?jdbcname=YWTemplate&style=1&yw_guid="+yw_guid;
}
function xzxs(){
    var yw_guid = ajaxRequest("<%=basePath%>","xfxs12336","getXzxsYW_GUID","");
    window.location.href("<%=basePath%>web/jizeWW/xsjb/xfxsTab.jsp?jdbcname=YWTemplate&style=0&yw_guid="+yw_guid); 
}
</script>
	</head>
