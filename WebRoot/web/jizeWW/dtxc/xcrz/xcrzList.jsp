...
<html>
  <head>
		...
		Ext.onReady(function(){
			...
			grid = new Ext.grid.GridPanel({
		        ...
		        columns: [
            		...
            		{header: '巡查日期', dataIndex:'XCRQ', width: width*0.1, sortable: true},
            		{header: '巡查单位', dataIndex:'XCDW', width: 90, sortable: true},
            		{header: '巡查区域', dataIndex:'XCQY', width: width*0.24, sortable: true},
	...
	function view(id){
		return "<a href='#' onclick='viewDetail("+id+");return false;'><img src='web/jizeWW/dtxc/images/view.png' alt='查看'></a>";
	}
	
	function viewDetail(id){
		var keyWord=Ext.getCmp('keyword').getValue();
		var yw_guid = myData[id].YW_GUID;
		var url = "<%=basePath%>web/jizeWW/dtxc/xcrz/xcrz.jsp?jdbcname=YWTemplate&yw_guid=" + yw_guid + "&num=" + myData[id].RUNNUM1 + "&isView=false&choseWord=" + escape(escape(keyWord)) + "&returnPath=web/jizeWW/dtxc/xcrz/xcrzList.jsp";
