...
<html>
	<head>
		...
		function toNext(){
			...
			document.location.href="<%=basePath%>/web/jizeWW/dtxc/xcrz/xcrz.jsp?jdbcname=YWTemplate&yw_guid=" + result + "&isView=false&num=<%=(Integer.parseInt(num)+1)%>&keyWord="+escape(escape("<%=keyWord%>"))+"&returnPath=web/jizeWW/dtxc/xcrz/xcrzList.jsp"; 
