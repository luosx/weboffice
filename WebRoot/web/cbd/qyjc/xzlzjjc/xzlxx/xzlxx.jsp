...
var bhs = "";	
	...
	function modify(i) {
		...
		c5.innerHTML = "<input id='cpdw1' size='10' value='"+selectedTr.cells[5].childNodes[0].nodeValue+"'/>";
		var c6 = newRow.insertCell(6);
		c6.innerHTML = "<input id='cplx1' size='10' value='"+selectedTr.cells[6].childNodes[0].nodeValue+"'/>";
		var c7 = newRow.insertCell(7);
		c7.innerHTML = "<input id='cylx1' size='10' value='"+selectedTr.cells[7].childNodes[0].nodeValue+"'/>";
		var c8 = newRow.insertCell(8);
		c8.innerHTML = "<input id='rzqy1' size='10' value='"+selectedTr.cells[8].childNodes[0].nodeValue+"'/>";
		var c9 = newRow.insertCell(9);
		c9.innerHTML = "<input id='kpsj1' size='10' value='"+selectedTr.cells[9].childNodes[0].nodeValue+"'/>";
		var c10 = newRow.insertCell(10);
		c10.innerHTML = "<input id='ysxkz1' size='10' value='"+selectedTr.cells[10].childNodes[0].nodeValue+"'/>";
		var c11 = newRow.insertCell(11);
		c11.innerHTML = "<input id='cbcs1' size='10' value='"+selectedTr.cells[11].childNodes[0].nodeValue+"'/>";
		var c12 = newRow.insertCell(12);
		c12.innerHTML = "<input id='lc1' size='10' value='"+selectedTr.cells[12].childNodes[0].nodeValue+"'/>";
		var c13 = newRow.insertCell(13);
		c13.innerHTML = "<input id='bzcg1' size='10' value='"+selectedTr.cells[13].childNodes[0].nodeValue+"'/>";
		var c14 = newRow.insertCell(14);
		c14.innerHTML = "<input id='wq1' size='10' value='"+selectedTr.cells[14].childNodes[0].nodeValue+"'/>";
		var c15 = newRow.insertCell(15);
		c15.innerHTML = "<input id='cn1' size='10' value='"+selectedTr.cells[15].childNodes[0].nodeValue+"'/>";
		var c16 = newRow.insertCell(16);
		c16.innerHTML = "<input id='gd1' size='10' value='"+selectedTr.cells[16].childNodes[0].nodeValue+"'/>";
		var c17 = newRow.insertCell(17);
		c17.innerHTML = "<input id='gs1' size='10' value='"+selectedTr.cells[17].childNodes[0].nodeValue+"'/>";
		var c18 = newRow.insertCell(18);
		c18.innerHTML = "<input id='dt1' size='10' value='"+selectedTr.cells[18].childNodes[0].nodeValue+"'/>";
		var c19 = newRow.insertCell(19);
		c19.innerHTML = "<input id='gdcw1' size='10' value='"+selectedTr.cells[19].childNodes[0].nodeValue+"'/>";
		var c20 = newRow.insertCell(20);
		c20.innerHTML = "<input id='tcwzj1' size='10' value='"+selectedTr.cells[20].childNodes[0].nodeValue+"'/>";
