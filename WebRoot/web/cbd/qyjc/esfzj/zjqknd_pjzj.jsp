...
<%@page import="com.klspta.web.cbd.qyjc.esf.common.ModelFactory"%>
<%
...
if(!isNaN(dom.value)){
	...
	if(datepjlm_id_cols_value!=null&&datepjlm_id_cols_value!=""){
		 datepjlm_id_cols_value=datepjlm_id_cols_value+"@"+dom.id+":"+dom.value
	}else{
	 datepjlm_id_cols_value=dom.id+":"+dom.value
	}
	}else{
	alert("写入数据有误！");
	dom.value="";
...
if(!isNaN(dom.value)){
	...
	if(datepjzj_id_cols_value!=null&&datepjzj_id_cols_value!=""){
		 datepjzj_id_cols_value=datepjzj_id_cols_value+"@"+dom.id+":"+dom.value
	}else{
	 datepjzj_id_cols_value=dom.id+":"+dom.value
	}
	}else{
	alert("写入数据有误！");
	dom.value="";
...
function newtab(){
	...
	var year=selt.options[selt.selectedIndex].value;
	   putClientCommond("qyjcManager", "getTable_ESF");
...
function save(){
	  var selt=document.getElementById("selt");
	  var year=selt.options[selt.selectedIndex].value;
	   putClientCommond("qyjcManager", "Save_Esf_Zjqk");
