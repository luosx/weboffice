   ...
   <div align="center" style="width: 100%;height: 95%">
     	<img src="web/cbd/sy/zkj.png" height="460px" width="850px" border="0" usemap="#planetmap" alt="总体设计图" />
              <map name="planetmap"  id="planetmap">
             	 ...
             	 <area shape="circle" coords="40,405,30"  href ="<%=basePath%>web/cbd/yzt/zrb/showRW/zrbViewFrame.jsp?view=R&closeMenu=*closeMenu*" alt="底层数据库" />
             	 <area shape="rect" coords="345,375,430,405" href ="<%=basePath%>/web/cbd/yzt/jbb/showRW/JbbViewFrame.jsp?closeMenu=*closeMenu*&view=R" alt="基本地块数据库" />
             	 <area shape="rect" coords="345,405,430,435" href ="<%=basePath%>web/cbd/yzt/zrb/showRW/zrbViewFrame.jsp?view=R&closeMenu=*closeMenu*" alt="自然斑数据库" />
