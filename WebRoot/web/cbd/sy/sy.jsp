...
Ext.onReady(function(){
 view=new Ext.Viewport({
  ...
  <body>
  <div style="position:absolute; top:35px; left:1250px; width:100px; height:100px;" align="right"><img src="base/form/images/go.png" width="50px" height="50px" title="系统设计图" onClick="javascript:window.location.href='jgs.jsp'"  /></div>
