...
function showMap(objid){
	...
	parent.parent.frames['east'].swfobject.getObjectById("FxGIS").findFeature("cbd", "1", key, "TBBH");
...
function setRecord(polygon){
	...
	parent.parent.frames['east'].swfobject.getObjectById("FxGIS").clear();
	parent.parent.frames['east'].swfobject.getObjectById("FxGIS").findFeature("cbd", "1", zrbbh, "TBBH");
}
