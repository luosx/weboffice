...
  				<input type="text" id="num" value="4" style="display:none" />
      <button>删除</button></td>
          ...
          <tr>
            ...
            <td><input type="text" id="hs_1" name="hs_1" onBlur="hushu(this)" style="width:50px; text-align:right; padding-right:5px" />
				<label>%</label>
                <input type="text" id="hsz_1" name="hsz_1" style="width:80px" /></td>
            <td><input type="text" id="hs_2" name="hs_2" onBlur="hushu(this)" style="width:50px; text-align:right; padding-right:5px" />
				<label>%</label>
                <input type="text" id="hsz_2" name="hsz_2" style="width:80px" /></td>
            <td><input type="text" id="hs_3" name="hs_3" onBlur="hushu(this)" style="width:50px; text-align:right; padding-right:5px" />
				<label>%</label>
                <input type="text" id="hsz_3" name="hsz_3" style="width:80px" /></td>
            <td><input type="text" id="hs_4" name="hs_4" onBlur="hushu(this)" style="width:50px; text-align:right; padding-right:5px" />
				<label>%</label>
          ...
          <tr>
            ...
            <td><input type="text" name="zhu_1" onBlur="zhu(this)" style="width:50px; text-align:right; padding-right:5px" />
				<label>%</label>
                <input type="text" name="zhuz_1" style="width:80px" /></td>
            <td><input type="text" name="zhu_2" onBlur="zhu(this)" style="width:50px; text-align:right; padding-right:5px" />
				<label>%</label>
                <input type="text" name="zhuz_2" style="width:80px" /></td>
            <td><input type="text" name="zhu_3" onBlur="zhu(this)" style="width:50px; text-align:right; padding-right:5px" />
				<label>%</label>
                <input type="text" name="zhuz_3" style="width:80px" /></td>
            <td><input type="text" name="zhu_4" onBlur="zhu(this)" style="width:50px; text-align:right; padding-right:5px" />
				<label>%</label>
          ...
          <tr>
            ...
            <td><input type="text" id="qi_1" name="qi_1" onBlur="qi(this)" style="width:50px; text-align:right; padding-right:5px" />
				<label>%</label>
              <input type="text" id="qiz_1" name="qiz_1" style="width:80px" /></td>
            <td><input type="text" id="qi_2" name="qi_2" onBlur="qi(this)" style="width:50px; text-align:right; padding-right:5px" />
				<label>%</label>
              <input type="text" id="qiz_2" name="qiz_2" style="width:80px" /></td>
            <td><input type="text" id="qi_3" name="qi_3" onBlur="qi(this)" style="width:50px; text-align:right; padding-right:5px" />
				<label>%</label>
              <input type="text" id="qiz_3" name="qiz_3" style="width:80px" /></td>
            <td><input type="text" id="qi_4" name="qi_4" onBlur="qi(this)" style="width:50px; text-align:right; padding-right:5px" />
				<label>%</label>
		  ...
		  <tr>
            ...
            <td><input type="text" id="tz_1" name="tz_1" style="width:50px; text-align:right; padding-right:5px" />
				<label>%</label>
              <input type="text" id="tzz_1" name="tzz_1" style="width:80px" /></td>
            <td><input type="text" id="tz_2" name="tz_2" style="width:50px; text-align:right; padding-right:5px" />
			<label>%</label>
              <input type="text" id="tzz_2" name="tzz_2" style="width:80px" /></td>
            <td><input type="text" id="tz_3" name="tz_3" style="width:50px; text-align:right; padding-right:5px" />
			<label>%</label>
              <input type="text" id="tzz_3" name="tzz_3" style="width:80px" /></td>
            <td><input type="text" id="tz_4" name="tz_4" style="width:50px; text-align:right; padding-right:5px" />
				<label>%</label>
