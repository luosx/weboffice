    ...
    var viewport = new Ext.Viewport({
        ...
        items:[{
            ...
            items: [
               		{
		                title: '待核查任务', 
		                html: "<iframe name='todo' style='height:"+(scrHeight)+"PX;' src='taskList.jsp' />"            
		       		},
	            	{
		                title: '已核查任务',    
		                html: "<iframe style='height:"+(scrHeight)+"PX;' src='MarkTab.jsp' />"            
		       		},
	            	{
		                title: '外业工作汇总',    
		                html: "<iframe style='height:"+(scrHeight)+"PX;' src='info.jsp' />"            
		       		}
            ]
        },{
            region: 'center',
