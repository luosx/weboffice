 ...
 Ext.onReady(function() {
	    ...
	    var tree = new Ext.tree.TreePanel({
	        ...
	        // alert(node.attributes.id+"----"+node.attributes.parentId);   
	                ...
	                //	parentMapTreeId='0';
	                //}
	                parent.mapInfo.location.href="<%=basePath%>/console/mapManage/mapTreeInfo.jsp?treeId="+nodeid+"&parentTreeId="+parentMapTreeId;   	  				  
	   ...
	   items:[{
		   		   ...
		   		   handler:function(tree){
						...
						parent.mapInfo.location.href="<%=basePath%>/console/mapManage/mapTreeInfo.jsp?treeId="+mapTreeId+"&parentTreeId="+selectMapTreeId;
		   		   		parent.parent.Ext.getCmp('west').collapse();
		   		   }
	   		   },{
		   		   text:"添加子图层",
        ...
        buttons: [
            {
                ...
                handler: function() {
                		var mapTreeId=newGuid();
		   		        ...
		   		        //页面刷新
		   		   		document.location.reload();
						parent.mapInfo.location.href="<%=basePath%>/console/mapManage/mapTreeInfo.jsp?treeId="+mapTreeId+"&parentTreeId=0";
		   		   		parent.parent.Ext.getCmp('west').collapse();
				}
          	}
        ]
