...
<body onload="MM_preloadImages('images/dl_btnB.gif')">
<form id='loginForm' method="post" action='<%=basePath %>j_spring_security_check'>
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="595" valign="top" background="images/login.jpg"><table width="1000" border="0" cellspacing="0" cellpadding="0">
      <tr>
      ...
      <tr>
        <td height="21">&nbsp;</td>
        <td><input name="j_password" type="password" class="input" id="j_password" /></td>
      </tr>
      <tr>
        <td height="53">&nbsp;</td>
        <td><table width="144" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="93"><font color='red'><%=type%></font></td>
            <td width="51"><a href="#" onclick='login();return false;' target="_parent" onmouseover="MM_swapImage('Image1','','images/dl_btnB.gif',1)" onmouseout="MM_swapImgRestore()"><img src="images/dl_btnA.gif" name="Image1" width="51" height="22" border="0" id="Image1" /></a></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
