...
<html>
  <head>
    <title>执法监察系统</title>
<script src="<%=basePath%>/common/js/cookies.js" type="text/javascript"></script>
...
document.onkeydown = exitFullScreen; 
  	...
  	<frameset id="main" name="main" rows="90,*" frameborder="no" border="0" framespacing="0" >
		<frame id="upper" name="upper" scrolling="NO" noresize
			src="<%=basePath%>gisapp/pages/upper.jsp" />
	  <frameset rows="52,*">
		<frame id="menu" name="menu" scrolling="NO" noresize
			src="<%=basePath%>gisapp/pages/menuIndex.jsp" />
		<frame id="lower" name="lower" scrolling="NO" noresize
			src="<%=basePath%>gisapp/pages/lowerIndex.jsp" />
		</frameset>
	</frameset>
</html>
