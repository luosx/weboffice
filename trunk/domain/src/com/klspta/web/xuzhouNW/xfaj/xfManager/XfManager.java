...
public class XfManager extends AbstractBaseBean {
	...
	public List<Map<String, Object>> getDCLListByUserId(String userId, String keyWord) throws Exception{
		...
		String sql = "select t.yw_guid,t.bh ,t.xslx,t.jbr, t.jbfs, t.bjbdw, t.lxdz, t.wtfsd, to_char(t.djsj,'yyyy-MM-dd hh24:mi:ss') as slrq, j.wfinsid from wfxsfkxx t join workflow.active_task j on t.yw_guid=j.yw_guid where j.assignee_=?";
		if (keyWord != null) {
	...
	public List<Map<String, Object>> getYCLListByUserId(String userId, String keyWord) throws Exception{
		...
		// 获取数据
		String sql = "select distinct t.yw_guid,t.bh ,t.xslx,t.jbr, t.jbfs, t.bjbdw, t.lxdz, t.wtfsd, to_char(t.djsj,'yyyy-MM-dd hh24:mi:ss') as slrq, j.wfinsid from wfxsfkxx t join workflow.hist_task j on t.yw_guid=j.yw_guid where j.assignee_=?";
		if (keyWord != null) {
			keyWord = UtilFactory.getStrUtil().unescape(keyWord);
	...
	public List<Map<String, Object>> getAllList(String keyWord){
		...
		DateFormat df = new SimpleDateFormat("yyyy-MM-dd");
		// 获取数据
		String sql = "select t.yw_guid,t.bh ,t.xslx,t.jbr, t.jbfs, t.bjbdw, t.lxdz, t.wtfsd, to_char(t.djsj,'yyyy-MM-dd hh24:mi:ss') as slrq, j.wfinsid from wfxsfkxx t join workflow.active_task j on t.yw_guid=j.yw_guid ";
		if (keyWord != null) {
			keyWord = UtilFactory.getStrUtil().unescape(keyWord);
