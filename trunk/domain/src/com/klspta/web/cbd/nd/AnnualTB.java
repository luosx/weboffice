...
public class AnnualTB extends AbstractBaseBean{
private static AnnualTB Annual;
...
private  AnnualTB(){
 ...
 public static  AnnualTB getAnnualTB(){
	 if (Annual == null) {
		 Annual = new AnnualTB();
        }
	 return Annual;
