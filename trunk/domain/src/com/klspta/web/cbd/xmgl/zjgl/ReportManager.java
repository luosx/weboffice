...
public class ReportManager extends AbstractBaseBean{
	...
	public List<XmzjglTreeBean> getBeanList(String yw_guid , String year){
		String sql = "select distinct t.yw_guid ,t.tree_id, t.tree_name,t.rq,t.parent_id,t.leval  from xmzjgl_zc t where t.yw_guid=? and t.rq=? order by t.parent_id, t.tree_name";
