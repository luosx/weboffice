...
public class QyjcManager extends AbstractBaseBean {
    ...
    public String getList() {
        ...
        result
                .append("<tr id='newRow' class='tr02' style='display:none;'>"
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            result.append("<tr id=row" + i + "><td class='tr02' >" + bh + "</td><td class='tr02' >" + xzlmc
                    + "</td><td class='tr02' >" + kfs + "</td><td class='tr02' >" + wygs
                    + "</td><td class='tr02' >" + tzf + "</td><td class='tr02' >" + cpdw
                    + "</td><td class='tr02' >" + cplx + "</td><td class='tr02' >" + cylx
                    + "</td><td class='tr02' >"

                    + rzqy + "</td><td class='tr02' >" + kpsj + "</td><td class='tr02' >" + ysxkz
                    + "</td><td class='tr02' >" + cbcs + "</td><td class='tr02' >" + lc
                    + "</td><td class='tr02' >" + bzcg + "</td><td class='tr02' >" + wq
                    + "</td><td class='tr02' >" + cn + "</td><td class='tr02' >"

                    + gd + "</td><td class='tr02' >" + gs + "</td><td class='tr02' >" + dt
                    + "</td><td class='tr02' >" + gdcw + "</td><td class='tr02' >" + tcwzj
                    + "</td><td class='tr02' >" + syl + "</td><td class='tr02' >" + qt
                    + "</td><td><a href='javascript:modify(" + i
                    + ")'>修改</a>&nbsp;&nbsp;<a href=\"javascript:del('" + bh + "')\">删除</a></td></tr>");
        }
        result.append("</table>");
    ...
    public void saveZJXX() {
        ...
        int i = update(insertString, YW, new Object[] { bh, xzlmc, kfs, wygs, tzf, cpdw, cplx, cylx, rzqy,
                kpsj, ysxkz, cbcs, lc, bzcg, wq, cn, gd, gs, dt, gdcw, tcwzj, syl, qt });
    ...
    public void updateZJXX() {
        ...
        String update = "update xzlxx set xzlmc='" + xzlmc + "',kfs='" + kfs + "',wygs='" + wygs + "',tzf='"
                + tzf + "',cpdw='" + cpdw + "',cplx='" + cplx + "',cylx='" + cylx + "',rzqy='" + rzqy
                + "',kpsj='" + kpsj + "',ysxkz='" + ysxkz + "',cbcs='" + cbcs + "',lc='" + lc + "',bzcg='"
                + bzcg + "',wq='" + wq + "',cn='" + cn + "',gd='" + gd + "',gs='" + gs + "',dt='" + dt
                + "',gdcw='" + gdcw + "',tcwzj='" + tcwzj + "',syl='" + syl + "',qt='" + qt
                + "' where bh = '" + bh + "'";
        System.out.print(update);
        int i = update(update, YW, new Object[] { bh, xzlmc, kfs, wygs, tzf, cpdw, cplx, cylx, rzqy, kpsj,
