...
public class GdtlHandler extends AbstractBaseBean {
	 ...
	 */
	public void getGdtlByQuarter() throws UnsupportedEncodingException{
		String year = request.getParameter("year");
		String quarter = request.getParameter("quarter");
		String xmmc = new String(request.getParameter("xmmc").getBytes("iso-8859-1"), "utf-8");
		String sql = "select * from plan供地体量 t where t.nd=? and t.jd=? and t.xmmc=?";
