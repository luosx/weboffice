...
public class ZjglData extends AbstractBaseBean {
	...
	public List<Map<String, Object>> getZJZC_father(String type, String year) {
		List<Map<String, Object>> list =null;
		String sql = "select t.tree_name as tree_name,t.tree_id as tree_id ,t.lj as lj,t.sort as sort,t.parent_id as parent_id from  XMZJGL_ZC_view t where tree_id=?  and rq=? and sort=1";
		list = query(sql, YW, new Object[] { type,  year });
		return list;
	}
	
	public List<Map<String, Object>> getZJLR_father(String type, String year) {
		List<Map<String, Object>> list =null;
		String sql = "select t.tree_name as tree_name,t.tree_id as tree_id ,t.lj as lj,t.parent_id as parent_id from  XMZJGL_LR_view t where tree_id=?  and rq=? ";
		list = query(sql, YW, new Object[] { type,  year });
		
		return list;
	}

	public List<Map<String, Object>> getZJZC_child(String tree_name, String parent_id, String year) {
		String sql = "";
		List<Map<String, Object>> list = null;
