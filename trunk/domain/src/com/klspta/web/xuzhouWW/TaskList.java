 ...
 * <br>Date:2011-5-3
 */
public class TaskList extends AbstractBaseBean{
    ...
    public String getWptbList(String xzqhdm) {
        ...
        for (int i = 0; i < rows.size(); i++) {
            ...
            oneRow.add((String)map.get("kc00")==null?0:map.get("kc00"));
            oneRow.add((String)map.get("xmc")==null?0:map.get("xmc"));
    ...
    public String getXzqh() {
        ...
        for (int i = 0; i < rows.size(); i++) {
            List oneRow = new ArrayList();
            Map map = (Map) rows.get(i);
            oneRow.add(map.get("qt_ctn_code"));
            oneRow.add(map.get("na_ctn_name"));
            allRows.add(oneRow);
        }
        return JSONArray.fromObject(allRows).toString();
    }
