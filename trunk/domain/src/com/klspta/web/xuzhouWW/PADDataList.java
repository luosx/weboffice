...
public class PADDataList extends AbstractBaseBean {
     ...
     * @return
     */
    public List getPADDataByYwguid(String yw_guid) {
        ...
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        List allRows = new ArrayList();
        List rows = query(sql, YW, new Object[] { yw_guid });
        return rows;
    }
     ...
     * @return
     */
    public List getPADCompareAnalysisDataByYwguid(String yw_guid) { // 'XC320120910002'
