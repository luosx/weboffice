...
import com.klspta.base.util.api.ICoordinateUtil;
import com.klspta.base.wkt.Point;

public class CoordinateUtil implements ICoordinateUtil {
    ...
    public static ICoordinateUtil getInstance(String key) throws Exception {
