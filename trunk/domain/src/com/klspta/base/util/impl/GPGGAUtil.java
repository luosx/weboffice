...
public final class GPGGAUtil implements IGPGGAUtil {
    ...
    private void parseGPGGA(String gpgga) {
        gpggas = gpgga.split(",");
        if(gpggas.length != 15 || gpggas[4] == null || gpggas[4].equals("") || gpggas[4].equals("00000.0000")){
        ...
        point80 = UtilFactory.getChangeCoordsSysUtil().changeMe(point84, IChangeCoordsSysUtil.GPS84_TO_BALIN80);
    }
}
