...
<html>
  <head>
	...
	function view(id){
		return "<a href='#' onclick='viewDetail("+id+");return false;'><img src='web/qingdaoNW/dtxc/images/view.png' alt='查看'></a>";
	}
	
	function viewDetail(id){
		var keyWord=Ext.getCmp('keyword').getValue();
		var yw_guid = myData[id].YW_GUID;
		var url = "<%=basePath%>web/qingdaoNW/dtxc/xcrz/xcrz.jsp?jdbcname=YWTemplate&yw_guid=" + yw_guid + "&num=" + myData[id].RUNNUM1 + "&isView=false&choseWord=" + escape(escape(keyWord)) + "&returnPath=web/qingdaoNW/dtxc/xcrz/xcrzList.jsp";
