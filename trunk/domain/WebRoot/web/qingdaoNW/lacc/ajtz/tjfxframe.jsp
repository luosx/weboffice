...
<%@page import="com.klspta.web.qingdaoNW.lacc.TjfxManager"%>
<%
...
function analy(){
	...
	<body>
        ...
        <div id="center1" >
        	<iframe id="xxtj" name="xxtj" style="width: 100%;height:100%; overflow: auto;" src="web/qingdaoNW/lacc/ajtz/tjtab.jsp"></iframe>
        </div>
