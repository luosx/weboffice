...
<%@page import="com.klspta.web.qingdaoNW.lacc.LaccManager"%>
<%
...
<html>
   ...
   Ext.onReady(function(){
	...
	var showPathN = "<%=basePath%>web/qingdaoNW/lacc/cljdcp/cljdcpb.jsp?jdbcname=YWTemplate&yw_guid=<%=yw_guid%>v02";
	var showPathF = "<%=basePath%>web/qingdaoNW/lacc/cljdcp/cljdcpb.jsp?jdbcname=YWTemplate&yw_guid=<%=yw_guid%>";
