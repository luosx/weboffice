...
<html>
   ...
   Ext.onReady(function(){
	...
	var showPathN = "<%=basePath%>web/qingdaoNW/lacc/flws/flwscpb.jsp?jdbcname=YWTemplate&yw_guid=<%=yw_guid%>v02";
	var showPathF = "<%=basePath%>web/qingdaoNW/lacc/flws/flwscpb.jsp?jdbcname=YWTemplate&yw_guid=<%=yw_guid%>";
