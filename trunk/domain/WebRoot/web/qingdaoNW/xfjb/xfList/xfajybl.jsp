...
<html>
	<head>
		...
		Ext.onReady(function(){
		   	putClientCommond("xfjbManager","getAllYCLList");
			myData = restRequest();
...
//新增信访
function add(){
	var url = "<%=basePath%>web/qingdaoNW/xfjb/xfdj/xfajTab.jsp";
...
function process(id){
	...
	var url = "<%=basePath%>web/qingdaoNW/xfjb/xfdj/xfajFrame.jsp?type=blz&yw_guid=" + id +"&keyWord=" + keyWord;
	document.location.href = url;
}
...
function query(){
	var keyWord=Ext.getCmp('keyword').getValue();
   	putClientCommond("xfjbManager","getYCLListByKeyWords");
