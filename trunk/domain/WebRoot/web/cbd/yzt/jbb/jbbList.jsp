		...
		Ext.onReady(function(){
			...
			grid = new Ext.grid.GridPanel({
		        ...
		        columns: [
		           ...
		           {header: '占地', dataIndex:'ZD', width:width*0.03-5, sortable: false, editor: {xtype: 'textfield',allowBlank: true},renderer:changKeyword},
		           {header: '建设用地', dataIndex:'JSYD',width:width*0.03-5, sortable: false,editor: {xtype: 'textfield',allowBlank: true},renderer:changKeyword},
		           {header: '容积率', dataIndex:'RJL',width:width*0.03-5, sortable: false, editor: {xtype: 'textfield',allowBlank: true},renderer:changKeyword},
		           {header: '建筑规模', dataIndex:'JZGM', width:width*0.03-3, sortable: false,editor: {xtype: 'textfield',allowBlank: true},renderer:changKeyword},
		           {header: '规划用途', dataIndex:'GHYT',width:width*0.03-3, sortable: false, editor: {xtype: 'textfield',allowBlank: true},renderer:changKeyword},
		           {header: '公建建筑规模', dataIndex:'GJJZGM',width:width*0.03, sortable: false, editor: {xtype: 'textfield',allowBlank:true},renderer:changKeyword},
		           {header: '居住建筑规模', dataIndex:'JZJZGM',width:width*0.03, sortable: false,editor: {xtype: 'textfield',allowBlank: true},renderer:changKeyword},
		           {header: '市政建筑规模', dataIndex:'SZJZGM',width:width*0.03, sortable: false, editor: {xtype: 'textfield',allowBlank: true},renderer:changKeyword},
		           {header: '总征收规模', dataIndex:'ZZSGM',width:width*0.03, sortable: false,editor: {xtype: 'textfield',allowBlank: true},renderer:changKeyword},
...
parent.frames['east'].frames["center"].frames["lower"].swfobject.getObjectById("FxGIS").findFeature("cbd", "1", bh, "TBBH");
 }		
