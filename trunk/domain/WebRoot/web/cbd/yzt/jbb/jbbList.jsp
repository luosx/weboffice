...
.tableheader {
	...
	border-bottom: 1px solid #8DB2E3;
		...
		Ext.onReady(function(){
			...
			//定义title
 			var con="<div style=\"height:60;width:"+(width*2.15+5)+"; background:url(base/thirdres/ext/examples/image-organizer/images/selected.gif);border-right:1px solid #D0D0D0\" >"+
 			...
 			"<td  rowspan=\"2\"  class=\"list_title_c\"  style=\"border-right:1px solid #D0D0D0;\" width='" + (width * 0.2) + "'><label>基本地块编号</label><td rowspan=\"2\" class=\"list_title_c\"  style=\"border-right:1px solid #D0D0D0;\" width='" + (width * 0.05) + "'><label>位置<br>查看</label></td></td>"+
 			...
 			"<tr class=\"tableheader\" ><td class=\"list_title_c\" style=\"border-right:1px solid #D0D0D0; \" width='" + (width * 0.08)+  "'><label>占地</label></td>"+
 			"<td class=\"list_title_c\" style=\"border-right:1px solid #D0D0D0; \" width='" + (width * 0.08)+  "'><label>建设用地</label></td><td class=\"list_title_c\" style=\"border-right:1px solid #D0D0D0; \" width='" + (width * 0.08)+  "'><label>容积率</label></td>"+
 			"<td class=\"list_title_c\" style=\"border-right:1px solid #D0D0D0; \" width='" + (width * 0.08)+  "'><label>建筑规模</label></td><td class=\"list_title_c\" style=\"border-right:1px solid #D0D0D0; \" width='" + (width * 0.08)+  "'><label>规划用途</label></td>"+
 			"<td class=\"list_title_c\" style=\"border-right:1px solid #D0D0D0; \" width='" + (width * 0.1)+  "'><label>公建建筑规模</label></td><td class=\"list_title_c\" style=\"border-right:1px solid #D0D0D0; \" width='" + (width * 0.1)+  "'><label>居住建筑规模</label></td>"+
 			"<td class=\"list_title_c\" style=\"border-right:1px solid #D0D0D0; \" width='" + (width * 0.1)+  "'><label>市政建筑规模</label></td><td class=\"list_title_c\" style=\"border-right:1px solid #D0D0D0; \" width='" + (width * 0.1)+  "'><label>总征收规模</label></td>"+
 			"<td class=\"list_title_c\" style=\"border-right:1px solid #D0D0D0; \" width='" + (width * 0.1)+  "'><label>住宅征收规模</label></td><td class=\"list_title_c\" style=\"border-right:1px solid #D0D0D0; \" width='" + (width * 0.1)+  "'><label>住宅征收户数</label></td>"+
 			"<td class=\"list_title_c\" style=\"border-right:1px solid #D0D0D0; \" width='" + (width * 0.08)+  "'><label>户均面积</label></td><td class=\"list_title_c\" style=\"border-right:1px solid #D0D0D0; \" width='" + (width * 0.1)+  "'><label>非住宅征收规模</label></td>"+
 			"<td class=\"list_title_c\" style=\"border-right:1px solid #D0D0D0; \" width='" + (width * 0.1)+  "'><label>非住宅家数</label></td><td class=\"list_title_c\" style=\"border-right:1px solid #D0D0D0; \" width='" + (width * 0.08)+  "'><label>开发成本</label></td>"+
 			"<td class=\"list_title_c\" style=\"border-right:1px solid #D0D0D0; \" width='" + (width * 0.08)+  "'><label>楼面成本</label></td><td class=\"list_title_c\" style=\"border-right:1px solid #D0D0D0; \" width='" + (width * 0.08)+  "'><label>楼面保本点</label></td>"+
 			"<td class=\"list_title_c\" style=\"border-right:1px solid #D0D0D0; \" width='" + (width * 0.08)+  "'><label>地面成本</label></td><td class=\"list_title_c\" style=\"border-right:1px solid #D0D0D0; \" width='" + (width * 0.12)+  "'><label>预计政府土地收益</label></td>"+
 			"<td class=\"list_title_c\" style=\"border-right:1px solid #D0D0D0; \" width='" + (width * 0.08)+  "'><label>存蓄比</label></td></tr></table>"
			var ht=con;
			...
			grid = new Ext.grid.GridPanel({
		        ...
		        columns: [
		           ...
		           {header: '非住宅家数', dataIndex:'FZZJS',width:width*0.1-3, sortable: false,editor: {xtype: 'textfield',allowBlank: true},renderer:changKeyword},
		           ...
		           {header: '楼面保本点', dataIndex:'LMBBD',width:width*0.08-3, sortable: false,editor: {xtype: 'textfield',allowBlank: true},renderer:changKeyword},
