...
var array = new Array();
var url = basePath
		+ 'web/cbd/yzt/swdt/hxxm/showRW/hxxmRowEditor.jsp?view='+view;
var condition = "";
                ...
                if(fp.getForm().isValid()){
	                fp.getForm().submit({
	                    ...
	                    success: function(fp, o){
							...
							parent.document.frames[0].frames['center'].frames["lower"].swfobject.getObjectById("FxGIS").findFeature("cbd", "17", guid, "XMNAME");
	                    	fp.getForm().reset();
	                	}
	                });
                }
