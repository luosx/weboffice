...
var array = new Array();
var url = basePath
		+ '/web/cbd/yzt/swdt/jbb/showRW/jbbRowEditor.jsp';
var condition = "";
var combo;
                ...
                if(fp.getForm().isValid()){
	                fp.getForm().submit({
	                    ...
	                    success: function(fp, o){
							...
							parent.document.frames[0].frames['center'].frames["lower"].swfobject.getObjectById("FxGIS").findFeature("cbd", "16", guid, "地块名称");
	                    	fp.getForm().reset();
	                	}
	                });
                }
