  ...
  <script type="text/javascript">
  	function save(){
  		...
  		for(var i = 0; i < document.getElementById("num").value; i++){
			...
			putRestParameter("year", document.getElementById("nd_" + (i + 1)).value);
			putRestParameter("quarter", document.getElementById("jd_" + (i + 1)).value);
	...
	function changeQuarter(check){
		...
		if(baseInformation.length > 0){
			...
			document.getElementById(name.replace(/jd/, "hs")).value = "";
			document.getElementById(name.replace(/jd/, "dl")).value = "";
			document.getElementById(name.replace(/jd/, "gm")).value = "";
			document.getElementById(name.replace(/jd/, "tz")).value = "";
			document.getElementById(name.replace(/jd/, "zhu")).value = "";
			document.getElementById(name.replace(/jd/, "qi")).value = "";
			document.getElementById(name.replace(/jd/, "hsz")).value = "";
			document.getElementById(name.replace(/jd/, "dlz")).value = "";
			document.getElementById(name.replace(/jd/, "gmz")).value = "";
			document.getElementById(name.replace(/jd/, "tzz")).value = "";
			document.getElementById(name.replace(/jd/, "zhuz")).value = "";
			document.getElementById(name.replace(/jd/, "qiz")).value = "";
