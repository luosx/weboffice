   ...
   .div2{
	...
	<div style="width: 100%;height: 100%;">
		<iframe id="west" name="west" class="div1" 
			style="width: 28%; height: 100%; overflow: auto; " src="bqzcyjinfo.jsp"></iframe>
		<iframe id="east" name="east" class="div2"
			style="width: 71%; height: 100%; overflow: auto; border: 0px;float: left;margin-left: 10px;margin-top: 0px" src="<%=basePath%>web/cbd/tjbb/chart.jsp?xml=xzlall.xml"></iframe>
	</div>
	</body>
</html>
