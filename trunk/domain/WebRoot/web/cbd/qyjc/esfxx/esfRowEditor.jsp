...
<html>
  <head>
	...
	<script src="web/cbd/qyjc/esfxx/js/table.js"></script>
	<script src="web/cbd/qyjc/esfxx/js/panel.js"></script>
	<script src="web/cbd/qyjc/esfxx/js/esfRowEditor.js"></script>
  ...
  <script type="text/javascript">
  	...
  	$(document).ready(function () { 
		...
		var height = document.body.clientHeight * 0.95;
       	FixTable("ESFXX", 0,1, width, height-30);
       	buildPanel();
    });
