...
function init(){
	document.getElementById("center1").innerHTML="<iframe id='xxtj' name='xxtj' style='width: 100%; height: 380px; overflow: auto;' src='<%=basePath%>web/cbd/tjbb/chart.jsp?xml=xzlsj.xml&lbxx='></iframe>";
}
</script>
	</head>
	<body onload="init();">
