...
function pro(id){
 return "<a href='#'onclick='process("+id+");return false;'><img src='<%=basePath%>web/jizeNW/lacc/dbaj/images/view.png' alt='办理'></a>";
}
...
function process(id){
	...
	var zfjcType="90";
	var returnPath="web/jizeNW/lacc/dbaj/dbaj.jsp";
