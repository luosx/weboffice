	...
	<script type="text/javascript">
		...
		Ext.onReady(function(){
			...
			grid = new Ext.grid.GridPanel({
		        ...
		        {header: '行政区划名称', dataIndex:'XJXZQHMC', width: width*0.1 , sortable: true},
				{header: '行政区划代码', dataIndex:'XJXZQHDM', width: width*0.1 , sortable: true},		
				{header: '图幅号', dataIndex:'TFH', width: width*0.1, sortable: true},
				{header: '图斑类型', dataIndex:'TBLX', width: width*0.1,sortable: true},
				{header: '图斑编号', dataIndex:'TBBH', width: width*0.1, sortable: true},				
				{header: '地类编码', dataIndex:'DLBM', width: width*0.1, sortable: true},		
				{header: '地类名称', dataIndex:'DLMC', width: width*0.1, sortable: true},
				{header: '权属性质', dataIndex:'QSXZ', width: width*0.1,sortable: true},
				{header: '权属单位代码', dataIndex:'QSDWDM', width: width*0.12, sortable: true},		
				{header: '权属单位名称', dataIndex:'QSDWMC', width: width*0.1, sortable: true},	
				{header: '图斑面积', dataIndex:'TBMJ', width: width*0.1, sortable: true},
