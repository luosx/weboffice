  ...
  <head>
	...
	<script type="text/javascript">
		...
		Ext.onReady(function(){
	  		putClientCommond("dxManager","getAllList");
			myData = restRequest();			
			...
			grid = new Ext.grid.GridPanel({
				...
				{header: '短信内容', dataIndex:'DXNR', width: width*0.48, sortable: true},
				{header: '接收人员', dataIndex:'JSRY', width: width*0.2, sortable: true},
				{header: '发送人', dataIndex:'FSR_NAME', width: width*0.07,sortable: true},		
