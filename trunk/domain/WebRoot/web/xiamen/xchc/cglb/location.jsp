...
Ext.onReady(function(){
	...
	<body>
		...
		<iframe id="center" name="center"  style="width: 100%; height:100%;overflow: auto;border: 0px" src="<%=basePath%>web/xiamen/xchc/cglb/showLocation.jsp?type=<%=type%>&yw_guid=<%=yw_guid%>"></iframe>
