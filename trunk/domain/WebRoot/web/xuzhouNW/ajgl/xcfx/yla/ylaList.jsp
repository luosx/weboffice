    ...
    grid = new Ext.grid.GridPanel({
        ...
        columns: [
           ...
           // {header: '任务类型', dataIndex:'RWLX',width: width*0.1, sortable: true},
            ...
            {header: '状态', dataIndex:'GPSID',width:width*0.08, sortable: false, renderer:check},
            {header: '详细信息', dataIndex:'ROWNUM1',width: width*0.07, sortable: false,renderer:view}
        ],
         tbar:[
