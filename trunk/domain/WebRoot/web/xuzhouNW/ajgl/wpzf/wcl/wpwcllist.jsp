...
Ext.onReady(function(){
    ...
    height=document.body.clientHeight;
        ...
        columns: [
            ...
            {header: '后时相特征', dataIndex:'HSX', width: width*0.15, sortable: true},
...
function sendTask(){
  window.showModalDialog("<%=basePath%>web/xuzhouNW/ajgl/xiafa/xiafa.jsp","","dialogWidth=650px;dialogHeight=450px;status=no;scroll=no");
  //  window.open("<%=basePath%>web/xuzhouNW/ajgl/xiafa/xiafa.jsp");
}
