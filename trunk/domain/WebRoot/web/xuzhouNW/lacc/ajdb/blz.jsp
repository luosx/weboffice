...
Ext.onReady(function(){
    myData= ajaxRequest("<%=basePath%>", "lacc", "getDBAJdata", 'userName=<%=userName%>');
	myData=eval(myData);
...
function process(id){
	...
	var url='<%=basePath%>model/workflow/wf.jsp?yw_guid='+yw_guid+'&wfInsTaskId='+wfInsTaskId+'&activityName='+escape(escape(activityName))+'&zfjcType=7&wfInsId='+wfInsId+'&zfjcName='+escape(escape('违法案件查处'))+'&wfId=ZFJC-1';  
	window.open(url); 
