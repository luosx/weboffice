...
<html>
	<head>
       ...
       Ext.onReady(function(){
          //alert('<%=hzqhs1%>');
	       putClientCommond("dtcc","getCityList");
      ...
      grid = new Ext.grid.GridPanel({
          ...
          columns: [
           ...
           {header: '处理意见',dataIndex:'SJCLYJ',width: width*0.15, sortable: true},
           {header: '处理意见',dataIndex:'XJCLYJ',width: width*0.15, sortable: true},
      ...
      function process(id){
	     ...
	     var flag = '0';
	     //var url='<%=basePath%>model/resourcetree/resourceTree.jsp?zfjcType=11&yw_guid='+yw_guid+'&returnPath='+returnPath;
