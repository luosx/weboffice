	...
	<head>
		...
		<script type="text/javascript">
			...
			Ext.onReady(function(){
			    ...
			    grid = new Ext.grid.GridPanel({
			        ...
			        columns: [
			            ...
			            {header: '处理', dataIndex:'ROWNUM1',width: width*0.05, sortable: false,renderer:view}
			        ],
			         tbar:[
			...
			function viewDetail(id){
                ...
                var url='<%=basePath%>web/jinan/dtxc/xccg/laframe.jsp?zfjcType=11&yw_guid='+yw_guid+'&returnPath='+returnPath+'&hiddenSave=true&edit=false'; 
