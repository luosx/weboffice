...
Ext.onReady(function(){
	putClientCommond("planeManager","getgdyswfList");
    ...
    var height=document.body.clientHeight*0.95;
        ...
        columns: [
            ...
            {header: '时间', dataIndex:'YEAR', width: width*0.1, sortable: true,renderer:changKeyword},
            {header: '供地项目名称', dataIndex:'XMMC', width: width*0.12, sortable: true,renderer:changKeyword},
            {header: '供地文号', dataIndex:'GDWH', width: width*0.14, sortable: true,renderer:changKeyword},
            {header: '压盖面积', dataIndex:'YGMJ', width: width*0.07, sortable: true,renderer:changKeyword},
            {header: '压盖比率', dataIndex:'YGBL', width: width*0.07, sortable: true,renderer:changKeyword},
...
function query(){
	...
	grid.reconfigure(store, new Ext.grid.ColumnModel([
            ...
            {header: '监测面积', dataIndex:'TBMJ', width: width*0.08, sortable: true,renderer:changKeyword},
            {header: '时间', dataIndex:'YEAR', width: width*0.06, sortable: true,renderer:changKeyword},
            {header: '供地项目名称', dataIndex:'XMMC', width: width*0.12, sortable: true,renderer:changKeyword},
            {header: '供地文号', dataIndex:'GDWH', width: width*0.14, sortable: true,renderer:changKeyword},
            {header: '压盖面积', dataIndex:'YGMJ', width: width*0.07, sortable: true,renderer:changKeyword},
            {header: '压盖比率', dataIndex:'YGBL', width: width*0.07, sortable: true,renderer:changKeyword},
