...
//点击查看时，查看详细信息
function process(id){
	var url = "<%=basePath%>web/sanya/zhbg/zhbgdj/wjspTab.jsp?type=sgthjzyt&yw_guid=" + id;
	document.location.href = url;
	//window.open(url);
}

function viewDetail(id){	
	var url = "<%=basePath%>web/sanya/zhbg/zhbgdj/wjspTab.jsp?type=sgthjzyt&yw_guid=" + myData[id-1].YW_GUID;
	document.location.href = url;	
}
