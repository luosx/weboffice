...
html, body { 
		...
		Ext.onReady(function(){
		   	putClientCommond("wjspHandler","getQTYCLList");
			myData = restRequest();
...
//点击查看时，查看详细信息
function process(id){
	var url = "<%=basePath%>web/sanya/zhbg/zhbgdj/wjspTab.jsp?type=qtybl&yw_guid=" + id;
	document.location.href = url;
	//window.open(url);
}
function viewDetail(id){	
	var url = "<%=basePath%>web/sanya/zhbg/zhbgdj/wjspTab.jsp?type=qtybl&yw_guid=" + myData[id-1].YW_GUID;
	document.location.href = url;	
}
...
function query(){
	var keyWord=Ext.getCmp('keyword').getValue();
   	putClientCommond("wjspHandler","getQTYCLListByKeyWords");
