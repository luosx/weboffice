...
<%
   ...
   // String tree=FlexManager.getInstance().getLayerCheckTreeByRoleId(roleId);
...
scrollbar-3dlight-color:#D4D0C8; 
  ...
  scrollbar-track-color:#;
	...
	<script>
	  putClientCommond("flexAction","getLayerCheckTreeByRoleId");
        ...
        buttons: [
            {
                ...
                handler: function() {
						...
						putClientCommond("flexAction","saveLayerRoleMap");
		   		        putRestParameter("roleId", "<%=roleId%>");
		   		        putRestParameter("layerList", treeIdList);
    					var result=restRequest();
					
					if(result=="success"){
						Ext.Msg.alert("提示","保存图层授权成功"); 
					}else{
						Ext.Msg.alert("提示","保存图层授权失败，请稍后重试或联系管理员。"); 
					}
						treeIdList="";
				}
          	}
